...
$(document).on('click','#submit-button',function(){var name=$("#username").val();var email=$("#email").val();var text=$("#message").val();var validE=validateEmail(email);var message="Por favor ingresa un correo electronico vàlido";var icon='error';var title='Oops ...';if(name==""||text==""){Swal.fire({icon:icon,title:title,text:'Favor de rellenar todos los campos'});}else if(!validE){Swal.fire({icon:icon,title:title,text:message});}else{Swal.fire({icon:'success',title:"Exito!",text:'Tu correo ha sido enviado'});}});function validateEmail(email){const re=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return re.test(String(email).toLowerCase());}
